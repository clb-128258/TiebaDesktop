...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_9.setMinimumSize(QtCore.QSize(0, 200))
        ...
        self.label_11.setStyleSheet("QLabel{color: grey;}")
        ...
        self.label_10.setStyleSheet("QLabel{color: grey;}")
    ...
    def retranslateUi(self, Form):
        ...
        self.toolButton.setToolTip(_translate("Form", "更多操作"))
